...
namespace RSMTenon.Data
{
    ...
    partial void DeleteStrategicModel(StrategicModel instance);
		...
		public System.Data.Linq.Table<TacticalModel> TacticalModels
		{
			get
			{
				return this.GetTable<TacticalModel>();
			}
		}
	...
	public partial class HistoricData : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private double _EMMA;
		
		private double _MAFU;
		
		private double _GLMA;
    ...
    partial void OnSSMA_TimeStampChanging(System.Data.Linq.Binary value);
    partial void OnSSMA_TimeStampChanged();
    partial void OnEMMAChanging(double value);
    partial void OnEMMAChanged();
    partial void OnMAFUChanging(double value);
    partial void OnMAFUChanged();
    partial void OnGLMAChanging(double value);
    partial void OnGLMAChanged();
		...
		[Column(Storage="_EMMA", DbType="Float NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public double EMMA
		{
			get
			{
			...
			set
			{
				if ((this._EMMA != value))
				{
					this.OnEMMAChanging(value);
					this.SendPropertyChanging();
					this._EMMA = value;
					this.SendPropertyChanged("EMMA");
					this.OnEMMAChanged();
				}
			}
		}
		
		[Column(Storage="_MAFU", DbType="Float NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public double MAFU
		{
			get
			{
			...
			set
			{
				if ((this._MAFU != value))
				{
					this.OnMAFUChanging(value);
					this.SendPropertyChanging();
					this._MAFU = value;
					this.SendPropertyChanged("MAFU");
					this.OnMAFUChanged();
				}
			}
		}
		
		[Column(Storage="_GLMA", DbType="Float NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public double GLMA
		{
			get
			{
			...
			set
			{
				if ((this._GLMA != value))
				{
					this.OnGLMAChanging(value);
					this.SendPropertyChanging();
					this._GLMA = value;
					this.SendPropertyChanged("GLMA");
					this.OnGLMAChanged();
				}
			}
		}
	...
	[Table(Name="dbo.tblTacticalModel")]
	public partial class TacticalModel : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnSSMA_TimeStampChanged();
		...
		[Column(Storage="_SEDOL", DbType="NVarChar(50)", UpdateCheck=UpdateCheck.Never)]
		public string SEDOL
		{
			get
			{
		...
		[Column(Storage="_WeightingHNW", DbType="Decimal(5,4) NOT NULL", UpdateCheck=UpdateCheck.Never)]
