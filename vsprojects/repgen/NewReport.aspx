            ...
            <InsertItemTemplate>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="listStrategy" runat="server" DataSource="<%# GetStrategies() %>"
                                DataTextField="Name" DataValueField="ID" DataMember="StrategyID" 
                                SelectedValue='<%# Bind("StrategyID") %>' AppendDataBoundItems="True">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="InitialFeeTextBox" runat="server" 
                                Text='<%# Bind("InitialFee") %>' />
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <asp:CompareValidator ID="validCompareStrategyID" runat="server" 
                    ControlToValidate="listStrategy" Display="None" 
                    ErrorMessage="Please select a Strategy from the list" Operator="NotEqual" 
