...
public partial class Pages_ReportSpec_upload : System.Web.UI.Page
{
    private static string spec = "report-spec.xml";
        ...
        if (uploader.PostedFile.ContentLength != 0) {
            try {
                if (uploader.PostedFile.ContentLength > 1000000) {
                    ...
                    string destPath = Server.MapPath(String.Format("~/App_Data/{0}", spec));
