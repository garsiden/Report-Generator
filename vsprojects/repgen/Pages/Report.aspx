<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Pages_Report" MasterPageFile="~/MasterPages/SiteMasterPage.master" %>
            ...
            <EditItemTemplate>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;
                            <asp:RadioButtonList ID="radioListStatusUpdate" runat="server" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="radioListStatus" runat="server" 
                                SelectedIndex='<%# Bind("Status") %>' Enabled="False" 
                                >
                                <asp:ListItem Selected="True">High Net Worth</asp:ListItem>
                                <asp:ListItem>Affluent</asp:ListItem>
                            </asp:RadioButtonList>
